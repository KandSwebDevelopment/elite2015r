 ...
 */
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    $sql = "select p.products_id, pd.products_name,
                  ...
                  pdex.multi_price,
                  pdex.sale_price,
                  pdex.trade_multi_price,
                  pdex.trade_multi_quantity,
                  pdex.box_quantity
           from   " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . 'product_extra_fields' . " pdex
           where  p.products_status = '1'
           and    p.products_id = '" . (int)$_GET['products_id'] . "'
           and    pd.products_id = p.products_id
...
// if review must be approved or disabled do not show review
  ...
  //Kands extra fields
  $products_dimensions_height = $product_info->fields['dimensions_height'];
  $products_dimensions_width = $product_info->fields['dimensions_width'];
  $products_dimensions_depth = $product_info->fields['dimensions_depth'];
  $products_bulbs_qty = $product_info->fields['bulbs_qty'];
  $products_bulbs_cap = $product_info->fields['bulbs_cap'];
  $products_bulbs_type = $product_info->fields['bulbs_type'];
  $products_bulbs_watts = $product_info->fields['bulbs_watts'];
  $products_manufacturers_code = $product_info->fields['manufactures_code'];
  $products_ip_rating = $product_info->fields['ip_rating'];
  $products_rrp = $product_info->fields['rrp'];
  $products_rate_1 = $product_info->fields['rate_1'];
  $products_rate_2 = $product_info->fields['rate_2'];
  $products_rate_3 = $product_info->fields['rate_3'];
  $products_bulbs_s1 = $product_info->fields['bulbs_s1'];
  $products_bulbs_s2 = $product_info->fields['bulbs_s2'];
  $products_show_price = $product_info->fields['show_price'];
  $products_web_price = $product_info->fields['web_price'];
