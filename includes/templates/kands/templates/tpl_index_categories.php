...
<div id="categoryDescription" class="catDescContent"><?php echo sprintf(TEXT_CATEGORIES_HELP, $breadcrumb->last())    ?></div>
...
//KandS - BOE For products listed on category page /////
//echo '<hr>';
...
//KandS - EOE For products listed on category page /////
?>
<?php
