...
if ($proddata != "") {
	...
	if ($bGblEnableTabs != TRUE) {
		...
		if ($IgnoreGlobals === false) {
			...
			if ($bGblCustom1_Tab == true && $IgnoreGlobals === false) {$bCustom1_Tab = 1;}
			if ($bGblCustom2_Tab == true && $IgnoreGlobals === false) {$bCustom2_Tab = 1;}
			if ($bGblCustom3_Tab == true && $IgnoreGlobals === false) {$bCustom3_Tab = 1;}
		}
        ...
        if(zen_not_null($result)){
          ...
          $SpecsResult = $result;
				...
				if ( $bDetailsOnTab != false && $hasSpecs ) {
					$bDetailsExist = 1;
        ...
        $familyResult .= ob_get_contents();
        ob_end_clean();
        if($familyResult != null){
				  $tabstrip .= "\n" . '<li><a href="javascript:void(0)" onclick="expandcontent(\'sc'.$g.'\', this)"><span>'.$custom1_tab_name.'</span></a></li>' . "\n";
          $hasFamily = true;
				  $g++;
        }
			}
			...
			if ($bCustom2_Tab != false) {
				$tabstrip .= "\n" . '<li><a href="javascript:void(0)" onclick="expandcontent(\'sc'.$g.'\', this)"><span>'.$custom2_tab_name.'</span></a></li>' . "\n";
				$g++;
			}
			// ===> Add Custom Tab 3 to tabs (tabstrip)
			if ($bCustom3_Tab != false) {
				$tabstrip .= "\n" . '<li><a href="javascript:void(0)" onclick="expandcontent(\'sc'.$g.'\', this)"><span>'.$custom3_tab_name.'</span></a></li>' . "\n";
				$g++;
			}
...
// Family Items build content for the tab into $fmtCust1
////////////////////////////////////////////////////////////////////////////////
			if ($bCustom1_Tab != false && $hasFamily == true) {
			  $fmtCust1 = "\n" . '<div class="centerColumn" id="customTab1Default">' . "\n";
        $fmtCust1 .= '<h2 class="centerBoxHeading">'.$custom1_tab_name.'</h2>';
        $fmtCust1 .= $familyResult;
			  $fmtCust1 .= "\n" . '</div>'. "\n\n";
      }
///// Family Items /////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
//      }
////////////////////////////////////////////////////////////////////////////////        
// Cross Sell build content for the tab into $fmtXSL
////////////////////////////////////////////////////////////////////////////////
			if ($bCrossSell_Tab != 0 && $num_products_xsell != 0) {
			  ob_start();
        $fmtXSL .= '<h2 class="centerBoxHeading">'.$cross_sell_tab_name.'</h2>';
...
//Reviews
      if ($bReviews_Tab != false) {
                ...
                $old_products_model = $products_model;
    			ob_start();
                ...
                $products_model = $old_products_model;                
...
//Image panel      
			if ($bMainImageOnTab != false) {
    			...
    			$fmtMainIm .= $one_time . ((zen_has_product_attributes_values((int)$_GET['products_id']) and $flag_show_product_info_starting_at == 1) ? TEXT_BASE_PRICE : TEXT_PRODUCT_PRICE_LABEL) . zen_get_products_display_price((int)$_GET['products_id']);
    			$fmtMainIm .= '</h2>';
...
//Description panel
          $tabcontent .= "\n" . '<div id="productDescription_'.$a.'" class="productGeneral biggerText">'.$sText[$a];
          if($product_info->fields['bulbs_s1']!=0){
            $tabcontent .= "\n" . '<br/><br>'. $product_info->fields['bulbs_s1'];
          }
					$tabcontent .= "\n" . '</div>';
					if ($bShowHeaders != true) {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ===> Cross Sell should be on tabs (content)
