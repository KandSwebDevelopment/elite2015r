...
zen_draw_radio_field('userType', 'b', '', 'class="user-type"') . ' Business User'; ?>
</div>
<br class="clearBoth" />
</fieldset>
...
<?php echo zen_draw_input_field('email_address', $email_address, zen_set_field_length(TABLE_CUSTOMERS, 'customers_email_address', '40') . ' id="email-address"'.' onfocus="reSetBKColor(event)"')  . (zen_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '<span class="alert">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>': ''); ?><br class="clearBoth" />

<div class="accCreateLeft"> <label class="inputLabel" for="email-addressConf">Confirm Email Address</label></div>
<?php echo zen_draw_input_field('email_addressConf', $email_addressConf, zen_set_field_length(TABLE_CUSTOMERS, 'customers_email_address', '40') . ' id="email-addressConf"'.' onfocus="reSetBKColor(event)"') . (zen_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '<span class="alert">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>': ''); ?><br class="clearBoth" />

<div class="accCreateLeft"><label class="inputLabel" for="password-new"><?php echo ENTRY_PASSWORD; ?></label></div>
<?php echo zen_draw_password_field('password', $password, zen_set_field_length(TABLE_CUSTOMERS, 'customers_password', '20') . ' id="password-new"'.' onfocus="reSetBKColor(event)"') . (zen_not_null(ENTRY_PASSWORD_TEXT) ? '<span class="alert">' . ENTRY_PASSWORD_TEXT . '</span>': ''); ?><br class="clearBoth" />

<div class="accCreateLeft"><label class="inputLabel" for="password-confirm">Retype Password</label></div>
<?php echo zen_draw_password_field('confirmation', $confirmation, zen_set_field_length(TABLE_CUSTOMERS, 'customers_password', '20') . ' id="password-confirm"'.' onfocus="reSetBKColor(event)"') . (zen_not_null(ENTRY_PASSWORD_CONFIRMATION_TEXT) ? '<span class="alert">' . ENTRY_PASSWORD_CONFIRMATION_TEXT . '</span>': ''); ?>
</fieldset>
...
<div class="accCreateLeft" id="pcDiv"><label class="inputLabel" id="pcText" for="postcode">Post/Zip Code</label></div>
<?php echo zen_draw_input_field('postcode', $postcode, zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_postcode', '40') . ' id="postcode"'.' onfocus="reSetBKColor(event)"') . (zen_not_null(ENTRY_POST_CODE_TEXT) ? '<span class="alert" id="pcAlert">' . ENTRY_POST_CODE_TEXT . '</span>': ''); ?>
<br class="clearBoth" />
</fieldset>
