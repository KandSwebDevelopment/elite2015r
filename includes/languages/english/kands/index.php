...
if ( ($category_depth == 'products') || (zen_check_url_get_terms()) ) {
	...
	define('TEXT_NO_FILTERED_PRODUCTS', 'There are no products with the filter selection(s) you have made.<br>Try changing your selection');  
...
//KAS
define('TEXT_CATEGORIES_HELP','Browse all items in %s or<br>Narrow your selection by picking a category below');
?>