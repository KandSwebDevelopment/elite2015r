...
if (GOOGLE_ANALYTICS_ENABLED == "Enabled") {
    ...
    if ((GOOGLE_CONVERSION_ACTIVE == "Yes") && ($_GET['main_page'] != FILENAME_CHECKOUT_SUCCESS)) {
        ...
        echo ("<noscript>\n");
        echo ("<div style=\"display:inline;\">\n");
        echo ("<img height=\"1\" width=\"1\" style=\"border-style:none;\" alt=\"\" src=\"//www.googleadservices.com/pagead/viewthroughconversion/" . GOOGLE_CONVERSION_IDNUM . "/?value=0&amp;&amp;guid=ON&amp;script=0\"/>\n");
        echo ("</div>\n");
        echo ("--></noscript>\n\n");
    }
}
