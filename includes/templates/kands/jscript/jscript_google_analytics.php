...
<?php
	    ...
	    $products = $db->Execute("select products_id, " . GOOGLE_ANALYTICS_SKU_CODE . " as skucode, products_name, final_price, products_quantity from " . TABLE_ORDERS_PRODUCTS . " where orders_id = '" . $ga_order->fields['orders_id'] . "'");
	    $items = "";
	    while(!$products->EOF) {
